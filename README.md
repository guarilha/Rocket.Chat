...
So if you'd like to be part of the project, please check out the [contributing guide](https://github.com/RocketChat/Rocket.Chat/wiki/How-can-I-contribute-to-Rocket-Chat%3F), [roadmap](https://github.com/RocketChat/Rocket.Chat/milestones) and [issues](https://github.com/RocketChat/Rocket.Chat/issues) to see if there's anything you can help with.
